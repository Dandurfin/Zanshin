...
# (gamepad pred audio_engine). Vynimka je `background` - app.py ho uz sam
# nepouziva a nacita ho az mixin (pri importe len nacita PIL). Mena
# spolocne pre app.py aj mixiny (app_log, nazvy jazykov, skratka "Teraz
# nie", ImageTk) su v app_spolocne.py - mixin nesmie importovat app
# (kruhovy import).
